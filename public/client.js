...
function setUsername() {
	...
	socket.emit(
		...
		
		{
			...
			google: document.getElementById('input-gogleid').value,
		...
		callback => {
			if (callback) {
				...
				window.alert(
					'  you dont have balance grater than 10 ETB  or your Username invalid, must be more than 3 characters in length, no spaces and unique chae this fix this things than you can goin the game)'
				);
			}
		}
	);
